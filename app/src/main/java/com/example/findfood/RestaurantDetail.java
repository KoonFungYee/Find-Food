...
public class RestaurantDetail extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private String name,state1,fbpage,rating1,distance1,building,latitude1,longtitude1,starttime,endtime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel", telnumber, null));
    ...
    private void setView(String name, String building, String starttime, String endtime, String rating2, String distance1,
        ...
        String url="http://www.socstudents.net/findfood/restaurant/"+name+".jpg";
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener navListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                ...
                case R.id.aroundme:
                    startActivity(new Intent(RestaurantDetail.this, AroundMe.class));
                    break;
