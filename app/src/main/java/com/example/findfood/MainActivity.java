...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView search, trending, buffet, western, bbq, halal, chinese, india, japanese,refresh;
    private TextView tvtrending, tvbuffet, tvwestern, tvbbq, tvhalal, tvchinese, tvindia,tvjapanese,restNo,allNo;
    private String trendingNo, buffetNo, westernNo, bbqNo, halalNo, chineseNo, indiaNo, japaneseNo, location="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getGPS();
                loadResultList(spinner.getSelectedItem().toString());
            }
        });
    ...
    private void initial() {
        ...
        refresh=findViewById(R.id.imageView59);
